...
class _InProgressState extends State<InProgress> {
  ...
  void initState() {
    super.initState();
    context.read<ProjectBloc>().add(FetchInProgressProjectsEvent());
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProjectBloc, ProjectState>(
      ...
      builder: (context, state) {
       ...
       else if (state is FetechProjectInProgressSuccefulState) {
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String formattedStartDate = projectDetails.startDate != null
                ? DateFormat('d MMMM yyyy').format(DateTime.parse(projectDetails.startDate!))
                : 'Unknown';
            String formattedEndDate = projectDetails.endDate != null
                ? DateFormat('d MMMM yyyy').format(DateTime.parse(projectDetails.endDate!))
                : 'Unknown';
                return Card(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                projectDetails.projectName ?? 'No Project Name',
                        ...
                        Padding(
                          ...
                          child: AnotherStepper(
                            ...
                            stepperList: List.generate(
                              projectDetails.steps!.length,
                              (stepIndex) {
                                return StepperData(
                                  iconWidget: Container(
                                    decoration: BoxDecoration(
                                      border: Border.all(color: BLUE_DARK_CLR),
                            ...
                            inActiveBarColor: DIVIDER_CLR,
                            activeBarColor: const Color(0XFF0052B4),
                          ),
                        ),
                        Padding(
